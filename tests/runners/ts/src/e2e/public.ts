...
function buildBody(over: Partial<MandateBody> = {}): MandateBody {
  return {
...
async function signedMandate(body: MandateBody, reqCaps: Hex[] = [], signWith: Hex = PAYER_PK): Promise<SignedMandate> {
