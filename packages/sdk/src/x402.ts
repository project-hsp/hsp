...
import { requiredCapabilitiesHash, type MandateBody, type SignedMandate } from '@hsp/core';
...
function buildHspMandate(signer: HSPSigner, chain: ChainConfig, req: PaymentRequirements, deadline: number): MandateBody {
  return {
